...
openModal('.buttons__button_three', '.modal[data-modal="three"]') // Запускаем функцию и передаем селекторы для второго модального окна
openModal('.buttons__button_four', '.modal[data-modal="four"]') // Запускаем функцию и передаем селекторы для второго модального окна
